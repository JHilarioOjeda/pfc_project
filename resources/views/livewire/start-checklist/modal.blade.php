                    ...
                    <div class="border border-gray-200 rounded-lg p-4">
                        ...
                        <div class="mt-3 flex flex-row gap-6">
                            <label class="inline-flex items-center">
                                <input type="radio" class="text-primarycolor focus:ring-primarycolor" wire:model.live="answers.{{ $key }}" value="1">
                                <span class="ms-2 text-sm text-gray-700">Sí</span>
                            </label>

                            <label class="inline-flex items-center">
                                <input type="radio" class="text-primarycolor focus:ring-primarycolor" wire:model.live="answers.{{ $key }}" value="0">
                        ...
                        @if(($answers[$key] ?? null) === '0')
                            <div class="mt-3">
                                <label class="block text-xs font-medium text-gray-700 mb-1">Razón <span class="text-red-500">*</span></label>
                                <textarea wire:model="reasons.{{ $key }}" rows="2" placeholder="Describe la razón..." class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primarycolor focus:border-transparent"></textarea>
                                @error('reasons.' . $key)
