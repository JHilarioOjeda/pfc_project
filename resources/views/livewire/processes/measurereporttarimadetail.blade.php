<div class="containerpric">
    ...
    <div class="bg-white rounded-lg shadow-lg my-3 p-4 space-y-6">
        ...
        @if (count($reports) > 0)
            <div class="flex flex-col gap-3 mb-2 sm:flex-row sm:items-end sm:justify-end">
                <div class="w-full sm:w-64">
                    <p class="text-secondarycolor">Folio para reporte:</p>
            ...
            <div class="flex flex-col gap-3 mb-2 sm:flex-row sm:items-end sm:justify-end">
                 <label class="inline-flex items-center cursor-pointer select-none text-sm text-secondarycolor">
                    Seleccionar todos
                    <input type="checkbox" class="size-5 rounded border-2 border-primarycolor text-primarycolor focus:ring-primarycolor focus:ring-offset-0 ml-2" wire:model.live="selectAll">
                </label>
            </div>
                ...
                <div class="border border-gray-200 rounded-lg p-3 space-y-3">
                    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-start text-sm">
                        ...
                        <div class="space-y-1 sm:text-right mt-2 sm:mt-0">
                            <p><span class="font-semibold">Folio:</span> {{ $report['folio'] ?? 'N/A' }}</p>
