<x-app-layout>
    ...
    <!-- BOTONES SUPERIORES -->
    <div class="mx-auto text-sm overflow-y-hidden flex mt-4 no-print" style="width: 27.94cm;">
        <x-secondary-hyperlink href="{{ route('storage') }}" class="!px-2 !py-1 !text-sm flex items-center">
